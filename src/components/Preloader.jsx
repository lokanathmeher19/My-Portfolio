        ...
        >
            ...
            <div style={{ 
                ...
                >
                    ...
                    <svg width="280" height="140" viewBox="0 0 100 50" style={{ pointerEvents: 'none' }}>
                        <defs>
                ...
                <div style={{ position: 'relative', overflow: 'hidden' }}>
                    ...
                    >
                        <motion.h1 
                            style={{ 
                                fontSize: '3.5rem', fontWeight: 900, color: '#fff', margin: 0,
                        ...
                        <motion.div 
                            ...
                            style={{ width: '80px', height: '1px', backgroundColor: 'var(--accent-cyan)', opacity: 0.4, transformOrigin: 'left' }} 
                        />
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            <h2 style={{ 
                                fontSize: '1rem', fontWeight: 300, color: '#fff', margin: 0,
