    ...
    >
      ...
      <div className="card" style={{ background: 'transparent', padding: 0 }}>
        <div style={{ textAlign: 'center', marginBottom: 60, position: 'relative' }}>
          ...
          {/* Glowing Project Filter Buttons */}
          <motion.div
            ...
            {categories.map(cat => (
              <motion.button
                ...
                style={{
                  padding: '8px 24px',
                  borderRadius: '30px',
                  border: `1px solid ${filter === cat ? '#38bdf8' : 'rgba(255,255,255,0.1)'}`,
                  background: filter === cat ? 'rgba(56, 189, 248, 0.1)' : 'rgba(20,20,20,0.6)',
                  color: filter === cat ? '#38bdf8' : '#aaa',
                  cursor: 'pointer',
                  fontWeight: 600,
                  fontSize: 14,
                  letterSpacing: 0.5,
                  transition: 'all 0.3s ease',
                  boxShadow: filter === cat ? '0 0 15px rgba(56, 189, 248, 0.4)' : 'none'
                }}
              >
                {cat}
              </motion.button>
        ...
        <motion.div layout className="projects-grid" style={{ display: 'grid', gap: 30, gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', maxWidth: 1000, margin: '0 auto' }}>
